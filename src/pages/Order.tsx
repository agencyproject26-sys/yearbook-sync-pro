  ...
  return (
    <MainLayout>
      ...
      <div className="p-6">
        ...
        {/* Orders Table */}
        <div className="rounded-xl border border-border bg-card overflow-hidden overflow-x-auto max-h-[calc(100vh-320px)]">
          <Table>
                  ...
                  <TableRow key={order.id}>
                    ...
                    <TableCell className="text-center">
                      <div className="flex flex-col items-center gap-1">
                        ...
                        >
                          <SelectTrigger className={`h-7 w-[110px] text-xs ${order.design_cover_status === "proses" || order.design_cover_status === "review" ? "bg-yellow-100 border-yellow-400 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300 dark:border-yellow-600" : order.design_cover_status === "selesai" ? "bg-emerald-100 border-emerald-400 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300 dark:border-emerald-600" : ""}`}>
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                    ...
                    <TableCell className="text-center">
                      <div className="flex flex-col items-center gap-1">
                        ...
                        >
                          <SelectTrigger className={`h-7 w-[110px] text-xs ${order.design_packaging_status === "proses" || order.design_packaging_status === "review" ? "bg-yellow-100 border-yellow-400 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300 dark:border-yellow-600" : order.design_packaging_status === "selesai" ? "bg-emerald-100 border-emerald-400 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300 dark:border-emerald-600" : ""}`}>
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                    ...
                    <TableCell className="text-center">
                      ...
                      >
                        <SelectTrigger className={`h-7 w-[90px] text-xs mx-auto ${(order.cetak_cover_status || "belum") === "proses" ? "bg-yellow-100 border-yellow-400 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300 dark:border-yellow-600" : (order.cetak_cover_status || "belum") === "selesai" ? "bg-emerald-100 border-emerald-400 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300 dark:border-emerald-600" : ""}`}>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <TableCell className="text-center">
                      ...
                      >
                        <SelectTrigger className={`h-7 w-[90px] text-xs mx-auto ${(order.cetak_isi_status || "belum") === "proses" ? "bg-yellow-100 border-yellow-400 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300 dark:border-yellow-600" : (order.cetak_isi_status || "belum") === "selesai" ? "bg-emerald-100 border-emerald-400 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300 dark:border-emerald-600" : ""}`}>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="belum">Belum</SelectItem>
